...
import type { GuestDetailModalProps } from "@/interfaces/components/app/dashboard/guest-list/interfaces";
...
export const GuestDetailModal: React.FC<GuestDetailModalProps> = ({
  ...
  const filteredGuests = useMemo(() => {
    ...
    return filtered;
  }, [guests, searchQuery, filterStatus, confirmedGuests, pendingGuests]);

  const filteredConfirmed = useMemo(
    () => filteredGuests.filter((g) => g.confirmed),
    [filteredGuests],
  );
