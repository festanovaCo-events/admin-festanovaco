...
import type { EventData } from "@/interfaces/api/event/data.interface";
import { localDateAndTimeFromDate } from "@/shared/lib/utils";

/**
 * Mapea el formato de evento de la API (`EventData`) al formato usado en el frontend (`Event`).
 * Compartido por todas las funciones de lectura de eventos en `@/shared/data/event`.
 */
